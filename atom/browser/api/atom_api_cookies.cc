...
void Cookies::Get(const base::DictionaryValue& filter,
  ...
  content::BrowserThread::PostTask(
      ...
      base::BindOnce(GetCookiesOnIO, getter, Passed(&copied), callback));
}
...
void Cookies::Remove(const GURL& url, const std::string& name,
  ...
  content::BrowserThread::PostTask(
      BrowserThread::IO, FROM_HERE,
      base::BindOnce(RemoveCookieOnIOThread, getter, url, name, callback));
}
...
void Cookies::Set(const base::DictionaryValue& details,
  ...
  content::BrowserThread::PostTask(
      BrowserThread::IO, FROM_HERE,
      base::BindOnce(SetCookieOnIO, getter, Passed(&copied), callback));
}
...
void Cookies::FlushStore(const base::Closure& callback) {
  ...
  content::BrowserThread::PostTask(
      BrowserThread::IO, FROM_HERE,
      base::BindOnce(FlushCookieStoreOnIOThread, getter, callback));
}
