...
void Protocol::UnregisterProtocol(
  ...
  content::BrowserThread::PostTaskAndReplyWithResult(
      ...
      base::BindOnce(&Protocol::UnregisterProtocolInIO, getter, scheme),
...
void Protocol::IsProtocolHandled(const std::string& scheme,
  ...
  content::BrowserThread::PostTaskAndReplyWithResult(
      content::BrowserThread::IO, FROM_HERE,
      base::Bind(&Protocol::IsProtocolHandledInIO, getter, scheme), callback);
}
...
void Protocol::UninterceptProtocol(
  ...
  content::BrowserThread::PostTaskAndReplyWithResult(
      content::BrowserThread::IO, FROM_HERE,
      base::BindOnce(&Protocol::UninterceptProtocolInIO, getter, scheme),
      base::BindOnce(&Protocol::OnIOCompleted, GetWeakPtr(), callback));
}
